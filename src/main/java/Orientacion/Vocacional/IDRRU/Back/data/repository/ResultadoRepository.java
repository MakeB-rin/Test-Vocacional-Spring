...
//        m.nombre,
//        f.nombre,
//        COUNT(r.estudiante.idEstudiante)
//    )
//    FROM Resultado r
//    INNER JOIN r.estudiante e
//    INNER JOIN r.municipio m
//    INNER JOIN r.facultad f
//    WHERE r.estudiante.idEstudiante = :id
//    GROUP BY m.nombre, f.nombre
//    ORDER BY m.nombre""")
//    List<ResultadoResponse> busquedaMunicipioList(@Param("id") Integer id);
